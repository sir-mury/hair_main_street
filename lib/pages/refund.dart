...
class _RefundPageState extends State<RefundPage> {
  ...
  void initState() {
    ...
    if (userController.adminVariables.value?.convinienceFee != null) {
      convenienceFee =
          userController.adminVariables.value!.convinienceFee! / 100;
    } else {
      convenienceFee = 0;
    }
    if (userController.adminVariables.value?.expiredFee != null) {
      expiredFee = userController.adminVariables.value!.convinienceFee! / 100;
    } else {
      expiredFee = 0;
    }
    super.initState();
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              ...
              if (validated) {
                ...
                if (selectedReason == "Expired Order") {
